...
function fetchBreads(){
    $.ajax({
        ...
        url: '/fetchBreads',
        success: function(response){
            //console.log(response.breads);
        
            if(!(jQuery.isEmptyObject(response.breads)))
            {
                $('#breads').html('');
            }            
            
            $.each(response.breads, function(name, dish){
...
function fetchAvailableBreads(){
    
    $.ajax({
        type: 'get',
        url: '/fetchAvailableBreads',
        beforeSend: function(){
            $('#available_breads').html('');
        },
        success: function(response){
...
function viewDetails(dish_id){
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response.bread, function(key, dish){
                $('#dish-image').html('\
                    <img src="images/dishes/'+dish.image+'" class="w-full h-full">\
                ');
    ...
    $.ajax({
        ...
        success: function(response){
            ...
            $.each(response.meal, function(key, dish){
                ...
                $('#form_dish_cart').find('#price').val(dish.price);
            })
        }
    })
}

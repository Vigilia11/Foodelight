<x-app-layout>
        ...
        <div class="max-w-6xl mx-auto">
            ...
            <div class="px-1 md:px-0">     
                ...
                <div class="mb-3 flex justify-center flex-wrap sm:justify-between md:justify-between items-center">
                    <h1 class="text-center sm:text-start md:text-start text-2xl font-extrabold text-gray-800 mb-2">Cakes</h1>
                    ...
                    <button data-modal-target="modal-add-dish" data-modal-toggle="modal-add-dish" class="text-white bg-rose-600 hover:bg-rose-700 font-semibold rounded text-sm px-5 py-1.5 -mt-2" type="button">
                        Add Cakes
                    </button>
                    @endif
                </div>                
        ...
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">            
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ url('/cake/store') }}" method="post" enctype="multipart/form-data" id="add_dish_form">
                        @csrf
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400 delete-message">Are you sure you want to delete this cake?</h3>
                    <input type="hidden" name="dish_id" id="dish_id" class="hidden bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded focus:ring-blue-500 focus:border-blue-500 w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"  required>
    ...
    <script src="{{ asset('js/admin/cakes.js') }}" defer></script>

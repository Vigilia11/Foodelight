<x-app-layout>
        ...
        <div class="max-w-6xl mx-auto">            
            <div class="px-1 md:px-0">                
                ...
                <div class="mb-3 flex justify-center flex-wrap sm:justify-between md:justify-between items-center">
                    <h1 class=" text-center sm:text-start md:text-start text-2xl font-extrabold text-gray-800 mb-2">Meals</h1>
                    ...
                    <button data-modal-target="modal-add-dish" data-modal-toggle="modal-add-dish" class="text-white bg-lime-700 hover:bg-lime-800 font-medium rounded text-sm px-5 py-1.5" type="button">
                        Add Meal
                    </button>
                    @endif
                </div>                
        ...
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">            
                ...
                <div class="p-4 md:p-5">
                    <form class="space-y-4" action="{{ route('meals.store') }}" method="post" enctype="multipart/form-data" id="add_dish_form">
                        @csrf
    ...
    <script src="{{ asset('js/admin/meals.js') }}" defer></script>
